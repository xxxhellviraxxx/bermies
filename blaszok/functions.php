...
define('MPC_THEME_VERSION', '3.9.9.4');
...
if ( ! function_exists( 'mpcth_wc_products_per_page' ) ) {
...
add_filter( 'blaszok/font', 'mpcth_theme_custom_fonts' );
function mpcth_theme_custom_fonts( $font_url ) {
	$custom_fonts = get_option( 'mpcth_custom_fonts' );
	...
	foreach ( $custom_fonts as $font ) {
		if ( isset( $font['name'] ) && false !== strpos( $font_url, $font['name'] ) ) {
			return isset( $font['source'] ) ? $font['source'] : '';
		}
	}
